                  ...
                  Container(
                    ...
                    child: ListView(
                      ...
                      children: <Widget>[
                        Container(
                          width: 8,
                          decoration: BoxDecoration(color: Color(0xFF131048)),
                        ),
                        SizedBox(width: 8.0),
                        Text(
                          "Catagories",
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            children: <Widget>[
                              _buildInfoCard(
                                  '0', 'assets/Pictures/grai.png', 'GRAINS'),
                            ],
                          )),
                          SizedBox(width: 20.0),
                          Container(
                            ...
                            children: <Widget>[
                              _buildInfoCard(
                                  '1', 'assets/Pictures/veg.png', 'VEGGIES'),
                            ],
                          )),
                          SizedBox(width: 20.0),
                          Container(
                            ...
                            children: <Widget>[
                              _buildInfoCard(
                                  '2', 'assets/Pictures/fru.png', 'FRUITS'),
                            ],
                          )),
                        ],
                      )),
      ...
      child: InkWell(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            IconButton(
                icon: Icon(Icons.add), onPressed: () {}, color: Colors.black)
          ],
        ),
      ),
    );
