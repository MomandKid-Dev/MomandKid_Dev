...
class _carousel extends State<carousel> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    monthController = PageController(
        initialPage: widget.selectedMonth - 1, viewportFraction: 1 / 4);
    dayController = PageController(
        initialPage: widget.selectedDay - 1, viewportFraction: 1 / 4);
                  ...
                  child: ClipRect(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                                color: Color.fromRGBO(0, 0, 0, 0.2 * opa),
                                spreadRadius: 0,
                                blurRadius: 2)
                          ]),
                    ),
                                  ...
                                  child: PageView.builder(
                                    ...
                                    onPageChanged: (int index) {
                                      setState(() {
                                        ...
                                        widget.callback(widget.selectedDay,
                                ...
                                child: Container(
                                    ...
                                    child: PageView.builder(
                                      itemCount: widget.date
                                          .getDayList(widget.selectedMonth)
                                          .length,
                                      scrollDirection: Axis.vertical,
...
dateList(
  ...
  animation = Tween<double>(begin: 1, end: index == current ? 1.5 : 1)
      .animate(controller);
      ...
      child: Container(
          ...
          child: AnimatedDefaultTextStyle(
            style: index == current
                ...
                : TextStyle(
                    fontSize: 32, color: Color.fromRGBO(255, 255, 255, alpha)),
            duration: Duration(milliseconds: 150),
