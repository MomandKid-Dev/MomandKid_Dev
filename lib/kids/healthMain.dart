                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    Container(
                                        ...
                                        child: widget.data.getRecent().length >
                                                0
                                            ? Column(
                                                crossAxisAlignment:
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Container(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: data.isContain(type)
                      ? <Widget>[
                          Text(
                              '${_kids.of(context).data.getKids()[0][textType]}')
                        ]
              ...
              child: Row(
                ...
                children: <Widget>[
                  Container(
                    ...
                    decoration: BoxDecoration(
                        shape: BoxShape.circle, color: Color(0xff8CEF75)),
                  ),
                  Text('สมส่วน')
                ],
              ),
...
Widget recent(BuildContext context, dataTest data) => Container(
      ...
      child: Column(
          children: data
              .getRecent()
              .map<Widget>((e) => cards(context, data, e['type']))
              .toList()),
    );
